...
hotel = Hotel.create(name: 'Your Hotel Name', address: 'Your Hotel Address')

User.create(name: 'John Doe', email: 'john@example.com', hotel: hotel)
User.create(name: 'Jane Smith', email: 'jane@example.com', hotel: hotel)

Room.create(hotel: hotel, name: 'Cozy Room', room_type: 'Double room', number_of_beds: 2, autumn_price: 165, winter_price: 169, spring_price: 159, summer_price: 169, description: 'A cozy room with a comfortable double bed, perfect for couples or solo travelers')

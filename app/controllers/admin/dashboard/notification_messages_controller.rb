...
module Admin
  module Dashboard
    class NotificationMessagesController < ApplicationController
      ...
      before_action :set_notification_message, only: %i[show edit update destroy]
      ...
      def create
        ...
        if @notification_message.save
          respond_to do |format|
            format.html do
              redirect_to admin_dashboard_notification_messages_path, notice: "Notification was successfully created."
            end
      ...
      def update
        if @notification_message.update(notification_message_params)
          respond_to do |format|
            format.html do
              redirect_to admin_dashboard_notification_messagess_path, notice: "Notification was successfully updated."
            end
      ...
      def destroy
        ...
        respond_to do |format|
          format.html do
            redirect_to admin_dashboard_notification_messagess_path, notice: "Notification was successfully destroyed."
          end

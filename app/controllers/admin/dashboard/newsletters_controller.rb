      ...
      def create
        ...
        if @newsletter.save
          ...
          respond_to do |format|
            format.html do
              redirect_to admin_dashboard_newsletters_path,
                notice: "Newsletter was successfully created and sent to subscribed users."
            end
            format.turbo_stream do
              flash.now[:notice] = "Newsletter was successfully created and sent to subscribed users."
            end
          end
        else

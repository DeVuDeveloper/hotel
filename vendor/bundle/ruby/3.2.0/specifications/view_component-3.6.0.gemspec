# -*- encoding: utf-8 -*-
# stub: view_component 3.6.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<benchmark-ips>.freeze, ["~> 2.12.0"])
    ...
    s.add_dependency(%q<benchmark-ips>.freeze, ["~> 2.12.0"])
    s.add_dependency(%q<better_html>.freeze, [">= 0"])
    s.add_dependency(%q<bundler>.freeze, ["~> 2"])
    s.add_dependency(%q<erb_lint>.freeze, [">= 0"])
    s.add_dependency(%q<haml>.freeze, ["~> 6"])
    s.add_dependency(%q<jbuilder>.freeze, ["~> 2"])
    s.add_dependency(%q<m>.freeze, ["~> 1"])
    s.add_dependency(%q<minitest>.freeze, ["~> 5.18"])
    s.add_dependency(%q<pry>.freeze, ["~> 0.13"])
    s.add_dependency(%q<rake>.freeze, ["~> 13.0"])
    s.add_dependency(%q<rubocop-md>.freeze, ["~> 1"])
    s.add_dependency(%q<standard>.freeze, ["~> 1"])
    s.add_dependency(%q<simplecov>.freeze, ["~> 0.22.0"])
    s.add_dependency(%q<simplecov-console>.freeze, ["~> 0.9.1"])
    s.add_dependency(%q<slim>.freeze, ["~> 5.1"])
